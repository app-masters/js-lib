export default function setup (accessToken, env, version, logOnDev, initializedCallback) {
    // console.log('rollbar setup');
    var _rollbarConfig = {
        accessToken: accessToken,
        globalAlias: 'rollbarDependence',
    ...
    !(function (r) {
        ...
        function o (r) {
            return function () {
                try {
                    ...
                    try {
                        console.log("[Rollbar]: Internal error", e);
                    } catch (o) {
                    }
                }
            };
        ...
        a.init = function (r, e) {
            ...
            if (typeof r[t] === "object") return r[t];
            ...
            var i = function () {
                ...
                }, l = !1, c = e.createElement("script"), d = e.getElementsByTagName("script")[0], p = d.parentNode;
            ...
            try {
                var o;
                if (o = typeof e === "function" ? e : function () {
                    return e || {};
                }, typeof r !== "function") return r;
        ...
        r.exports = function (r, e) {
            return function (o) {
                if (!o && !window._rollbarInitialized) {
                    ...
                    if (initializedCallback) initializedCallback(i);
                }
            };
        };
    }]));
    ...
    window.onerror = function (message, source, lineno, colno, error) {
        // RUN IT ON DEV?
        if (env !== 'development' || logOnDev) {
            console.log('Error sent to rollbar', error);
